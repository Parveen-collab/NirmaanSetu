...
/auth/send-otp-forgot, /auth/reset-password=done, /auth/refresh?refreshToken=string, get/user/:id, delete/user/:id, Patch/user/:id, /user/all?role=EMPLOYEE&keyword=string, /sms/send?phone=string
